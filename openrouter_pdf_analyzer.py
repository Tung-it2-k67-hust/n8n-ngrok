...
Chức năng:
    1. Quét các file .pdf trong thư mục.
    ...
    4. Ghi trực tiếp kết quả vào file .md.
...
def main():
    ...
    for pdf_path in pdf_files:
        ...
        # --- TEST MODE ---
        if filename != "Kotlin_Coroutines_Basics.pdf":
            continue
        # -----------------
        ...
        for chunk, start_page in chunk_pages(all_pages, CHUNK_SIZE):
            ...
            if content:
                ...
                print(f"     -> Xong chunk {chunk_range}. Đã ghi vào {output_filename}")
            else:
